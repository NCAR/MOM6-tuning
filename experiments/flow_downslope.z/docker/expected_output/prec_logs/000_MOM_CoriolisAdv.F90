# 1 "/root/MOM6-tuning/experiments/flow_downslope.z/prec_logs/prec_logs-c0e592ff.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/root/MOM6-tuning/experiments/flow_downslope.z/prec_logs/prec_logs-c0e592ff.F90"
...
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%jsd:G%jed,G%ke), INTENT(IN) :: uh
REAL(kind=8), DIMENSION(G%isd:G%ied,G%JsdB:G%JedB,G%ke), INTENT(IN) :: vh
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%jsd:G%jed,G%ke), INTENT(OUT) :: CAu
REAL(kind=8), DIMENSION(G%isd:G%ied,G%JsdB:G%JedB,G%ke), INTENT(OUT) :: CAv
TYPE ( ocean_OBC_type ) , POINTER :: OBC
TYPE ( accel_diag_ptrs ) , INTENT(INOUT) :: AD
TYPE ( unit_scale_type ) , INTENT(IN) :: US
TYPE ( CoriolisAdv_CS ) , POINTER :: CS
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB) :: Area_q
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB) :: Ih_q
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB) :: q
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%jsd:G%jed) :: d
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%jsd:G%jed) :: c
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%jsd:G%jed) :: b
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%jsd:G%jed) :: a
REAL(kind=8), DIMENSION(G%isd:G%ied,G%jsd:G%jed) :: KE
REAL(kind=8), DIMENSION(G%isd:G%ied,G%jsd:G%jed) :: Area_h
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%jsd:G%jed) :: uh_center
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%jsd:G%jed) :: KEx
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%jsd:G%jed) :: hArea_u
REAL(kind=8), DIMENSION(G%isd:G%ied,G%JsdB:G%JedB) :: vh_center
REAL(kind=8), DIMENSION(G%isd:G%ied,G%JsdB:G%JedB) :: KEy
REAL(kind=8), DIMENSION(G%isd:G%ied,G%JsdB:G%JedB) :: hArea_v
REAL(kind=8), DIMENSION(G%isd:G%ied,G%jsd:G%jed) :: ep_v
REAL(kind=8), DIMENSION(G%isd:G%ied,G%jsd:G%jed) :: ep_u
REAL(kind=8), DIMENSION(G%isd:G%ied,G%jsd:G%jed) :: vh_max
REAL(kind=8), DIMENSION(G%isd:G%ied,G%jsd:G%jed) :: vh_min
REAL(kind=8), DIMENSION(G%isd:G%ied,G%jsd:G%jed) :: uh_max
REAL(kind=8), DIMENSION(G%isd:G%ied,G%jsd:G%jed) :: uh_min
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB) :: min_fuq
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB) :: max_fuq
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB) :: min_fvq
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB) :: max_fvq
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB) :: q2
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB) :: abs_vort
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB) :: dudy
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB) :: dvdx
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB,G%ke) :: RV
REAL(kind=8), DIMENSION(G%IsdB:G%IedB,G%JsdB:G%JedB,G%ke) :: PV
REAL(kind=8) :: fu2
REAL(kind=8) :: fu1
REAL(kind=8) :: fv2
REAL(kind=8) :: fv1
...
REAL(kind=8), PARAMETER :: C1_24 = 1.0 / 24.0
REAL(kind=8) :: absolute_vorticity
REAL(kind=8) :: relative_vorticity
REAL(kind=8) :: Ih
REAL(kind=8) :: min_Ihq
REAL(kind=8) :: max_Ihq
REAL(kind=8) :: hArea_q
