...
FMS_BLD_DIR="${MOM6_TUNING_ROOT}"/build/intel/shared/repro
MOM6_BLD_DIR="${MOM6_TUNING_ROOT}"/build/intel/ocean_only/repro
INTEL_MKMF_TEMPLATE="${MOM6_TUNING_ROOT}"/src/mkmf/templates/cheyenne-intel.mk
