...
! support lots of Fortran compilers.
      ...
      SUBROUTINE MPI_Sizeof_complex128_scalar(x, size, ierror)
       INTEGER,PARAMETER :: real128 = SELECTED_REAL_KIND(30)!USE, INTRINSIC :: iso_fortran_env, ONLY: REAL128
      COMPLEX(REAL128)::x
        INTEGER, INTENT(OUT) :: size
        INTEGER, INTENT(OUT) :: ierror
      ...
      SUBROUTINE MPI_Sizeof_complex32_scalar(x, size, ierror)
       INTEGER,PARAMETER :: real32 = SELECTED_REAL_KIND(6)!USE, INTRINSIC :: iso_fortran_env, ONLY: REAL32
      COMPLEX(REAL32)::x
        INTEGER, INTENT(OUT) :: size
        INTEGER, INTENT(OUT) :: ierror
      ...
      SUBROUTINE MPI_Sizeof_complex64_scalar(x, size, ierror)
       INTEGER,PARAMETER :: real64 = SELECTED_REAL_KIND(15)!USE, INTRINSIC :: iso_fortran_env, ONLY: REAL64
      COMPLEX(REAL64)::x
        INTEGER, INTENT(OUT) :: size
        INTEGER, INTENT(OUT) :: ierror
      ...
      SUBROUTINE MPI_Sizeof_int16_scalar(x, size, ierror)
        INTEGER,PARAMETER :: int16 = SELECTED_INT_KIND(4)!USE, INTRINSIC :: iso_fortran_env, ONLY: INT16
      INTEGER(INT16)::x
        INTEGER, INTENT(OUT) :: size
        INTEGER, INTENT(OUT) :: ierror
      ...
      SUBROUTINE MPI_Sizeof_int32_scalar(x, size, ierror)
        INTEGER,PARAMETER :: int32 = SELECTED_INT_KIND(9)!USE, INTRINSIC :: iso_fortran_env, ONLY: INT32
      INTEGER(INT32)::x
        INTEGER, INTENT(OUT) :: size
        INTEGER, INTENT(OUT) :: ierror
      ...
      SUBROUTINE MPI_Sizeof_int64_scalar(x, size, ierror)
        INTEGER,PARAMETER :: int64 = SELECTED_INT_KIND(18)!USE, INTRINSIC :: iso_fortran_env, ONLY: INT64
      INTEGER(INT64)::x
        INTEGER, INTENT(OUT) :: size
        INTEGER, INTENT(OUT) :: ierror
      ...
      SUBROUTINE MPI_Sizeof_int8_scalar(x, size, ierror)
        INTEGER,PARAMETER :: int8 = SELECTED_INT_KIND(2)!USE, INTRINSIC :: iso_fortran_env, ONLY: INT8
      INTEGER(INT8)::x
        INTEGER, INTENT(OUT) :: size
        INTEGER, INTENT(OUT) :: ierror
